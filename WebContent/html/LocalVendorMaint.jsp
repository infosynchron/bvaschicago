...
<TITLE>LocalVendorMaint.jsp</TITLE>
</HEAD>
<%
...
<BODY bgcolor="#999999">
	<html:form action="/LocalVendorMaint.do">
						...
						<TABLE align="center">
							<TBODY>
								<TR align="center">
									<TD align="center">
										<%
            ErrorBean errorBean = (session.getAttribute("LocalVendorMaintError") != null) ?
            						(ErrorBean) session.getAttribute("LocalVendorMaintError") : new ErrorBean();
							...
							<TBODY>
								<TR>
									<TD><html:submit onclick="AddNewVendor()"
											value="Add New Vendor" style="width: 120px;"></html:submit></TD>
									<TD><html:submit onclick="ChangeVendor()"
											value="Change Vendor" style="width: 120px;"></html:submit></TD>
									<TD><html:submit onclick="DeleteVendor()"
											value="Delete Vendor" style="width: 120px;"></html:submit></TD>
									<TD><html:submit onclick="Clear()" value="Clear"
											style="width: 120px;"></html:submit></TD>
									<TD>
										<% 
                        	String myPage = "http://" + serverName + "/bvaschicago/html/reports/LocalVendorListing.html";
                        	String printMethod = "NewWindow('"+myPage+"', 'Ram','400','400','yes');return true;"; %>
										<html:submit onclick="<%= printMethod %>"
											value="Print Listing" style="width: 120px;"></html:submit>
									</TD>
									<TD><html:submit onclick="ReturnToMain()"
											value="Return To Main" style="width: 120px;"></html:submit></TD>
								</TR>
							</TBODY>
						</TABLE>
					</TD>
