...
public class PrintClientsApplet extends JApplet implements Printable {

    JFrame frame;
    JTable tableView;

    // This is a hack to avoid an ugly error message in 1.1.
    public PrintClientsApplet() {
        frame = new JFrame("Todays Orders");
        frame.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e)
                {System.exit(0);}});

        final String[] headers = {"Customer Id",
            "Company Name", "Contact Name", "Contact Title", "Terms",
		...
		pj.setPrintable(PrintClientsApplet.this);
		pj.printDialog();
