...
public class PrintVendorsApplet extends JApplet implements Printable {

    JFrame frame;
    JTable tableView;

    // This is a hack to avoid an ugly error message in 1.1.
    public PrintVendorsApplet() {
        frame = new JFrame("Todays Orders");
        frame.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e)
                {System.exit(0);}});

        final String[] headers = {"Vendor Id",
            "Company Name", "Contact Name", "Contact Title", "Home Page",
            "eMail" };
		...
		pj.setPrintable(PrintVendorsApplet.this);
		pj.printDialog();
