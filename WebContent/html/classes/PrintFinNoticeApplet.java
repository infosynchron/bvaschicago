...
public class PrintFinNoticeApplet extends JApplet implements Printable {

    JFrame frame;
    JTable tableView;

    // This is a hack to avoid an ugly error message in 1.1.
    public PrintFinNoticeApplet() {
		...
		pj.setPrintable(PrintFinNoticeApplet.this);
		pj.printDialog();
