...
<BODY bgcolor="#999999">
	<html:form action="/DamagedParts.do" focus="partNo">
		<html:hidden property="buttonClicked" value=""></html:hidden>
		<TABLE width="550" border="1" align="center">
			<TBODY>
				<TR>
					<TD width="550" align="center" height="50" style="font-size: 24pt"><B>DAMAGED
						...
						<table align="center">
							...
							<TR>
								...
								<TD align="left" style="font-size: 11pt"><html:text
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									Suggested Discount: &nbsp;&nbsp; <html:text size="15"
										property="suggestedDiscount">
									</html:text></TD>
							</TR>
							<%
            ...
            %>
							<TR>
								<TD align="right" style="font-size: 11pt">Damage
									Description:</TD>
								<TD align="left"><html:text size="60"
										property="damagedDesc" maxlength="40"></html:text></TD>
							</TR>
					...
					<TD width="550" align="center" valign="middle">
						<TABLE>
							<TR>
								<TD>
									<%
            ErrorBean errorBean = (session.getAttribute("DamagedPartsError") != null) ?
            						(ErrorBean) session.getAttribute("DamagedPartsError") : new ErrorBean();
					...
					<TD width="550" align="center" valign="middle">
						<TABLE>
							<TR>
								...
								<TD>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<html:submit onclick="Delete()" value="Delete"
