...
public class UpdateOurPrice {
  ...
  public static void updateOurPrices(List<InvoiceDetailsOurPrice> missingourpricelist,
      String targetdDB) {
  ...
  public static List<InvoiceDetailsOurPrice> getMissingOurPrice(String db) {
    String sql =
