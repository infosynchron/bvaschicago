...
import com.bvas.formBeans.VendorMaintForm;
import com.bvas.utils.DateUtils;
import com.bvas.utils.ErrorBean;

public class VendorMaintAction extends Action {
  private static final Logger logger = Logger.getLogger(VendorMaintAction.class);

  public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      HttpServletResponse response) throws IOException, ServletException {

    VendorMaintForm vForm = (VendorMaintForm) form;
    ...
    if (session == null || session.getAttribute("User") == null) {
      logger.error("No session or no User in VendorMaintAction");
      buttonClicked = null;
      forwardPage = "Login";
    }
    ...
    Object o = session.getAttribute("Vendor");
    ...
    if (buttonClicked == null || buttonClicked.equals("")) {
      ...
      try {
        if (supplierId != 0) {
          vendor = VendorBean.getVendor(supplierId);
    ...
    if (errorBean.getError() != null) {
      session.setAttribute("VendorMaintError", errorBean);
    } else {
      session.removeAttribute("VendorMaintError");
    }
  ...
  public void fillForm(VendorMaintForm vForm, VendorBean vBean) {
  ...
  public VendorBean fillBean(VendorMaintForm vForm) {
  ...
  public void fillBeanForChange(VendorMaintForm vForm, VendorBean vendor) {
